...
public class Ship extends AppCompatActivity {
    ...
    Integer append=1;
    Integer append2 =0;
    CheckBox[] myCheck = new CheckBox[59];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myCheck[0] = (CheckBox) findViewById(R.id.shiptrip);
        System.out.println(myCheck[0]);
        for(int i=1; i < 59; i++){
            String entryname = null;
            myCheck[i] = (CheckBox) findViewById(R.id.shiptrip+i);
    ...
    private void save(final boolean isChecked){
        ...
        editor.putBoolean("ship", isChecked);
        editor.commit();
    }
    ...
    private void save2(final boolean isChecked){
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean("ship"+String.valueOf(append), isChecked);
        editor.commit();
        append++;
    }
    ...
    private boolean load(){
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean("ship", false);
    }

    private boolean load2(){
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        append2++;
        String id = "ship"+String.valueOf(append2);
