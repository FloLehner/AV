...
public class Familyvacation extends AppCompatActivity {
    CheckBox[] myCheck = new CheckBox[68];
    Integer append=1;
    Integer append2 =0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_familyvacation);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        myCheck[0] = (CheckBox) findViewById(R.id.familyvacation);
        System.out.println(myCheck[0]);
        for(int i=1; i < 68; i++){
            String entryname = null;
            myCheck[i] = (CheckBox) findViewById(R.id.familyvacation+i);
    ...
    private void save(final boolean isChecked){
        ...
        editor.putBoolean("family", isChecked);
        editor.commit();
    }
    ...
    private void save2(final boolean isChecked){
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putBoolean("family"+String.valueOf(append), isChecked);
        editor.commit();
        append++;
    }
    ...
    private boolean load(){
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean("family", false);
    }

    private boolean load2(){
        SharedPreferences sharedPreferences = getPreferences(Context.MODE_PRIVATE);
        append2++;
        String id = "family"+String.valueOf(append2);
